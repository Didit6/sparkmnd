...
return (
  ...
  <div className="whitesmoke">
    <h3 className="videotitle">{item.id2}</h3>
    <div className="videolayout">
      <iframe className="iframclass" src={item.image2} title={item.id2} frameborder="0" allow="autoplay; encrypted-media" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
    </div>
    <p className="pstyle"><strong><u>Description:</u></strong> {item.title2}</p>
  </div>
            );})}
</div>
